...
m?.chat ? await conn.sendMessage(m.chat, {text: args[0] ? `@${m.sender.split('@')[0]}, ya estás conectado, leyendo mensajes entrantes...` : `genial @${m.sender.split('@')[0]}, bienvenido a la familia de VEGETA-BOT MD estás listo para la aventura.`, mentions: [m.sender]}, { quoted: m }) : ''
