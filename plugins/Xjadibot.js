...
*1- Diríjase en los tres puntos en la esquina superior derecha*
...
let id = `${who.split`@`[0]}` 
let pathGataJadiBot = path.join("./Kenny_sub_bots/", id)
...
handler.command = /^(jadibot|serbot|pene|code)/i
...
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['KennyBot-MD (Sub Bot)', 'Chrome','2.0.0'],
